...
Change Log:
    ...
    1.0.3   26/01/2016  Corrected a minor bug in the output generated by the Get-TargetResource function.
...
Function ValidateProperties {
    ...
    if ($List_CdDrives.Count -ge 1) {
        ...
        $CdRomAllocatedDriveLetters = $CdRomAllocatedDriveLetters.Remove($CdRomAllocatedDriveLetters.Length -1)
        ...
        if ($CdRomDriveLetterAllocation -eq 'Default') {
            switch ($Mode) {
                'Get'  {
                    $ReturnData = @{
                        CdRomAllocatedDriveLetters = $CdRomAllocatedDriveLetters
                        CdRomDriveLetterAllocation = 'Default'
                    }
                    Return $ReturnData
                }
